...
| [`dataform-example/`](dataform-example/) | **The pipeline** — config-driven reporting for eight markets (MT, ES, DK, BG, GR, NL, DE, FR), rule engine, nomenclature, player protection, fault isolation, offline DuckDB harness. See its `README.md`, `ARCHITECTURE.md`, `SETUP.md`, `CLAUDE.md` and `docs/diagrams/` |
